    ...
    <View style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity style={styles.navIcon} activeOpacity={0.7}>
          <Ionicons name="home-outline" size={22} color={colors.font2} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.navIcon} activeOpacity={0.7}>
          <Ionicons name="restaurant-outline" size={22} color={colors.font2} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.navIcon} activeOpacity={0.7}>
          <Ionicons name="heart-outline" size={22} color={colors.font2} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.navIcon} activeOpacity={0.7}>
          <Ionicons name="clipboard-outline" size={22} color={colors.font2} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.navIcon} activeOpacity={0.7}>
          <Ionicons name="headset-outline" size={22} color={colors.font2} />
        </TouchableOpacity>
      </View>
    </View>
  )
